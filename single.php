...
try{
    $sql =" SELECT  news.id, news.newsDate,news.title,news.content,news.active, news.image, categorytable.categoryName FROM `news` INNER JOIN categorytable ON news.category=categorytable.id WHERE news.id =?";
    $id = $_GET["id"];
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="single.php" class="nav-item nav-link active">Single News</a>
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href=""><?php echo $Category?></a>
                                <a class="text-body" href=""><?php echo $NewsDate?></a>
                            </div>
