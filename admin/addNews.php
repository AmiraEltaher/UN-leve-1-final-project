...
if($_SERVER["REQUEST_METHOD"] === "POST"){   
	...
	try{
	  ...
	  $sql = "INSERT INTO `news`(`newsDate`, `title`, `content`, `author`, `active`, `image`, `category`) VALUES (?,?,?,?,?,?,?)";
	  $stmt=$conn->prepare($sql);
	  $stmt->execute([$NewsDate, $Title, $Content, $Author,$Active, $image_name, $Category]);
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="<?php echo htmlspecialchars($_SERVER ["PHP_SELF"]); ?>" method ="POST"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="News-date">News Date <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="News-date" required="required" class="form-control " name="news-date">
											</div>
										</div>
										<div class="item form-group">
