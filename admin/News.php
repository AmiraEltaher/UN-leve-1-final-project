                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php 
                      ...
                      $id = $row["id"];
                      $Date = $row["newsDate"];
                      $NewsDate = date("j M Y",strtotime($Date));
                      $Title = $row["title"];
                    ...
                    ?>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="editNews.php?id=<?php echo $id ?>"><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href="deleteNews.php?id=<?php echo $id ?> "><img src="./images/delete.png" alt="Delete"></a></td>
                        </tr>
                    <?php
                      }
                    ?>
